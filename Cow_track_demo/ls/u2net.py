...
class segmentModel:
    def __init__(self, config):
        ...
        if torch.cuda.is_available():
            self.net.load_state_dict(torch.load(config['segment_model_path']))
            self.net.cuda()
        else:
            self.net.load_state_dict(torch.load(config['segment_model_path'], map_location='cpu'))
        self.net.eval()
    ...
    def forward(self, img):
        ...
        # cv2.imshow('cv2_img_in 2222', img)
