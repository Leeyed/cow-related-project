...
from model.utils import cpu_nms, gpu_nms
from model.utils import parse_line
import os
import args as args
...
def voc_eval_for_confindence(gt_dict, val_preds, classidx, iou_thres=0.5, use_07_metric=False):
    '''
    Top level function that does the PASCAL VOC evaluation.
    '''
    # 1.obtain gt: extract all gt objects for this class
