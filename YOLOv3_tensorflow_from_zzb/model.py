...
from model.utils import conv2d, darknet53_body, yolo_block, upsample_layer
from model.utils import focal_loss
...
class yolov3(object):
    ...
    def loss_layer(self, feature_map_i, y_true, anchors):
        ...
        # use focal loss
        class_loss_pos = conf_pos_mask * focal_loss(pred_prob_logits, y_true[..., 5:-1], alpha=0.25, gamma=2) * mix_w
        class_loss = tf.reduce_sum(class_loss_pos) / N
        # use softmax
        # tf.nn.softmax_cross_entropy_with_logits()

        return xy_loss * 10, wh_loss * 10, conf_loss, class_loss
...
class yolov3_bodai(object):
    ...
    def compute_loss(self, y_pred, y_true):
        ...
        for i in range(len(y_pred)):
            ...
            loss_conf += result[2]
            loss_class += result[3]
        total_loss = loss_xy + loss_wh + loss_conf*10 + loss_class
        return [total_loss, loss_xy, loss_wh, loss_conf, loss_class]
