...
def parse_anno(annotation_path, target_size=None):
    ...
    for line in anno:
        s = line.strip().split(' ')
        # line: img_id img_path label bbox
        # img_w = int(s[2])
        # img_h = int(s[3])
        # s = s[4:]
        #
...
# yolo anchor 10,13, 16,30, 33,23, 30,61, 62,45, 59,119, 116,90,  156,198,  373,326
# cow face anchor 8,17, 10,20, 13,21, 12,23, 14,24, 15,23, 16,26, 50,89, 68,120